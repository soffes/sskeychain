...
/**
 Error code specific to SSFKeychain that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your
 platform.
 */
typedef NS_ENUM(OSStatus, SSFKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	SSFKeychainErrorBadArguments = -1001,
};

/** SSFKeychain error domain */
extern NSString *const kSSFKeychainErrorDomain;

/** Account name. */
extern NSString *const kSSFKeychainAccountKey;
 ...
 */
extern NSString *const kSSFKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kSSFKeychainClassKey;

/** Item description. */
extern NSString *const kSSFKeychainDescriptionKey;

/** Item label. */
extern NSString *const kSSFKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kSSFKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kSSFKeychainWhereKey;
...
/**
 ...
 See the `NSString` constants declared in SSFKeychain.h for a list of keys that can be used when accessing the
...
#import <SSKeychain/SSFKeychainQuery.h>
